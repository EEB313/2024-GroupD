...
Null hypothesis: Temperature increases by climate change will have no effect on *Batrachochytrium dendrobatidis* prevalence on *Litoria wilcoxii*. 

Alternative hypothesis: Temperature increases by climate change will have an effect on *Batrachochytrium dendrobatidis* prevalence on *Litoria wilcoxii*. 
...
# Prediction
 Increased temperature from climate change will benefit Litoria wilcoxii abundance over time until a biological threshold is reached. 
Previous research has shown that the parasite Batrachochytrium, in its stationary phase, thrives in colder temperatures of 13-15 degrees Celcius, with a rapid decline of density at around 26 degrees Celcius (Stevenson et al., 2013). The same study demonstrated that the parasite grows best at around 21 degrees Celcius (Stevenson et al., 2013).  Evidence shows that zoospore activity decreases as temperature increases, which correlates with reduced lethality (and infection?) of hosts (Stevenson et al., 2013). In vivo experiments support this, as reduced mortality is seen in subjects receiving higher temperatures for treatment (Berger et al., 2004).
