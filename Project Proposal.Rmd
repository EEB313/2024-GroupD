...
Null hypothesis: Temperature increases by climate change will have no effect on *Batrachochytrium dendrobatidis* (*Bd*) prevalence on *Litoria wilcoxii*. 

Alternative hypothesis: Temperature increases by climate change will have an effect on *Batrachochytrium dendrobatidis* (*Bd*) prevalence on *Litoria wilcoxii*. 
...
Previous research has shown that the parasite Batrachochytrium, in its stationary phase, thrives in colder temperatures of 13-15 degrees Celcius, with a rapid decline of density at around 26°C (Stevenson et al., 2013). The same study demonstrated that the parasite grows best at around 21°C (Stevenson et al., 2013). Evidence shows that zoospore activity decreases as temperature increases, which correlates with reduced prevalence of *Bd* in hosts (Sapsford et al., 2013; Stevenson et al., 2013). In vivo experiments support this, as reduced mortality is seen in subjects receiving higher temperatures for treatment (Berger et al., 2004).
